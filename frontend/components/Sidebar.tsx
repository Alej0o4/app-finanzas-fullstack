...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`bg-surface border-border/70 fixed top-0 left-0 z-40 flex h-screen flex-col justify-between border-r transition-all duration-300 ease-in-out ${isSidebarOpen ? 'w-64' : 'w-20'}`}
    >
          ...
          <div className="bg-background/40 border-border/40 flex items-center justify-between rounded-xl border p-2 px-3">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-text-muted text-[10px] capitalize">{user?.email || ''}</span>
              </div>
            </div>
